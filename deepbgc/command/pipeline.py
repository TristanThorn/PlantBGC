...
Examples:
  ...
  """
    ...
    def add_arguments(self, parser):
        ...
        group.add_argument('--merge-max-protein-gap', default=10, type=int, help="Merge detected BGCs within given number of proteins (default: %(default)s)")
        group.add_argument('--merge-max-nucl-gap', default=50000, type=int, help="Merge detected BGCs within given number of nucleotides (default: %(default)s)")
        group.add_argument('--min-nucl', default=500, type=int, help="Minimum BGC nucleotide length (default: %(default)s)")
